      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="p-4">
          <Tabs defaultValue="active">
            ...
            <TabsContent
              value="active"
              className="space-y-3 overflow-auto max-h-[calc(100vh-300px)]"
            >
              {isLoading ? (
                ...
                activeMissions.map((mission) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between text-xs text-gray-500">
                      ...
                      <span>
                        {mission.startTime
                          ? formatDistanceToNow(new Date(mission.startTime), {
                              addSuffix: true,
                            })
                          : ""}
                      </span>
                ...
                scheduledMissions.map((mission) => (
                  ...
                  >
                    ...
                    <p className="text-gray-500 text-sm mb-1">
                      ...
                      {mission.missionType.charAt(0).toUpperCase() +
                        mission.missionType.slice(1)}
                      {mission.isRecurring && (
                        <>
                          <span className="mx-1">•</span>
                          <span className="material-icons text-xs align-text-bottom mr-1">
                  ...
                  >
                    ...
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
                      <span className="flex items-center">
                        ...
                        {mission.endTime
                          ? format(new Date(mission.endTime), "MMM d, h:mm a")
                          : "Recently"}
                      </span>
                      <span>
                        <Button
