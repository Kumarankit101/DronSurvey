  ...
  const onSubmit = async (data: MissionFormValues) => {
    try {
      ...
      const submissionData = {
        ...
        surveyPatternData,
        surveyParameters,
        // Convert scheduled time to ISO string
        scheduledTime: new Date(data.scheduledTime).toISOString()
      };
      
      // Submit to API
      await apiRequest('POST', '/api/missions', submissionData);
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g. Facility A Roof Inspection" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                >
                  ...
                  <TabsContent value="crosshatch" className="pt-2">
                    <FormDescription>
                      Covers the area in a crisscross pattern for maximum coverage, ideal for detailed inspections.
                    </FormDescription>
                  </TabsContent>
                  <TabsContent value="perimeter" className="pt-2">
                    <FormDescription>
                      Follows the boundaries of the area, good for security and boundary inspections.
                    </FormDescription>
                  </TabsContent>
                  <TabsContent value="grid" className="pt-2">
                    <FormDescription>
                      Systematic pattern with parallel lines for consistent coverage.
                    </FormDescription>
                  </TabsContent>
                </Tabs>
                <FormMessage />
