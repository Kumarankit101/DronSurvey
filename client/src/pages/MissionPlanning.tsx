                ...
                <Tabs defaultValue="details" className="w-full">
                  ...
                  <TabsContent value="details">
                    <div className="space-y-4">
                      <div>
                        <h3 className="text-xl font-medium">{selectedMission.name}</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        ...
                        <div>
                          <h4 className="text-sm text-gray-500 mb-1">Location ID</h4>
                          <p>{selectedMission.locationId || "Not specified"}</p>
                        </div>
                        
                        <div>
                          <h4 className="text-sm text-gray-500 mb-1">Drone Assigned</h4>
                          <p>{selectedMission.droneId ? `Drone #${selectedMission.droneId}` : "Not assigned"}</p>
                        </div>
                        
                        <div>
                          <h4 className="text-sm text-gray-500 mb-1">Mission Type</h4>
                          <p className="capitalize">{selectedMission.missionType}</p>
                        </div>
                        ...
                        <div>
                          <h4 className="text-sm text-gray-500 mb-1">Recurring</h4>
                        ...
                        {selectedMission.surveyParameters ? (
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-gray-50 p-3 rounded-md">
                              <h4 className="text-sm text-gray-500 mb-1">Flight Altitude</h4>
                              <p className="text-lg font-medium">
                                {(selectedMission.surveyParameters as any).altitude || "N/A"} meters
                              </p>
                            </div>
                            
                            <div className="bg-gray-50 p-3 rounded-md">
                              <h4 className="text-sm text-gray-500 mb-1">Overlap</h4>
                              <p className="text-lg font-medium">
                                {(selectedMission.surveyParameters as any).overlap || "N/A"}%
                              </p>
                            </div>
                            
                            <div className="bg-gray-50 p-3 rounded-md">
                              <h4 className="text-sm text-gray-500 mb-1">Flight Speed</h4>
                              <p className="text-lg font-medium">
                                {(selectedMission.surveyParameters as any).speed || "N/A"} m/s
                              </p>
                            </div>
                          </div>
                        ) : (
                          <p className="text-gray-500">No survey parameters specified.</p>
                        )}
                      </div>
                        ...
                        <div className="bg-gray-50 p-3 rounded-md">
                          <div className="flex items-center">
                            <span className="material-icons text-gray-600 mr-2">
                              {selectedMission.missionType === 'perimeter' ? 'crop_square' : 
                               selectedMission.missionType === 'crosshatch' ? 'grid_on' : 'grid_3x3'}
                            </span>
                            <div>
                              <h4 className="font-medium capitalize">{selectedMission.missionType}</h4>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {selectedMission.scheduledTime && (
                          <div className="bg-gray-50 p-3 rounded-md">
                            <h4 className="text-sm text-gray-500 mb-1">Scheduled Start</h4>
                            <p className="text-lg font-medium">
                        ...
                        {selectedMission.startTime && (
                          <div className="bg-gray-50 p-3 rounded-md">
                            <h4 className="text-sm text-gray-500 mb-1">Actual Start</h4>
                            <p className="text-lg font-medium">
                        ...
                        <div>
                          ...
                          <div className="bg-gray-50 p-3 rounded-md">
                            <p className="capitalize mb-1">
                              <span className="material-icons text-gray-600 text-sm align-text-bottom mr-1">repeat</span>
                              {selectedMission.recurringPattern}
                            </p>
                            
                            {selectedMission.recurringDays && selectedMission.recurringDays.length > 0 && (
                              <div className="text-sm text-gray-500">
                                Days: {(selectedMission.recurringDays as number[]).map(day => {
